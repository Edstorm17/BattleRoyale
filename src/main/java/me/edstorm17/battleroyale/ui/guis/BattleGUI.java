...
public class BattleGUI extends BaseGUI {
    ...
    public void initializeItems(Player player) {
        ...
        setItemAt(7, 3, new ClickableItem(ItemBuilder.builder().material(Material.LIME_CONCRETE).displayName(ChatColor.GREEN + "CONFIRM").build(), p -> {
